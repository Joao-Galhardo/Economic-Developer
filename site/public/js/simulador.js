function simular() {
    ...
    var valorInicial = Number(input_valor_inicial.value);
    var valorMensal = Number(input_valor_mensal.value);
    var taxaJuros = Number(input_taxa_juros.value);
    ...
    if (
      ...
      valor_final.innerHTML += `R$${total.toFixed(2)}`;
      valor_cImpostos.innerHTML += `R$${totalCImpostos.toFixed(2)}`
    }
  }